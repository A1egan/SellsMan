(function() {
  ...
  function installBoardDragOptimizations() {
    ...
    globalThis.onDragLeave = function() {
      // Intentionally keep the current highlight. onDragOver switches it once when
      // entering another column; dragend/drop clears it. This avoids dragleave churn
      // while the pointer crosses hundreds of child elements.
    };
